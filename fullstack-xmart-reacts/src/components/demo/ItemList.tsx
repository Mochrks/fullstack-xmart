    ...
    <div className="bg-neutral-100">
      <div className="flex flex-row w-full h-full mx-auto gap-5 p-5 ">
        ...
        <div className="flex flex-col w-full h-full items-center justify-center mx-auto">
          ...
          <div className="flex flex-row w-full h-full items-center justify-center mx-auto  ">
            <div className=" rounded-2xl w-1/1 p-5 overflow-auto bg-white shadow-xl ">
              ...
              <div className="flex flex-row flex-wrap  h-[750px]  overflow-y-scroll gap-5  ">
                <div>
            ...
            <div className="flex flex-col rounded-2xl w-1/4 p-5 ">
              <div className="flex h-[850px] rounded-2xl flex-col overflow-y-scroll bg-white shadow-xl">
